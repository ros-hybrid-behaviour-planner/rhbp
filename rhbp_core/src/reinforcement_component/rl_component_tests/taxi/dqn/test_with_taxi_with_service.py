        ...
        for i in range(1,13500):
            ...
            if self.cycles_last == num_prints:
                ...
                if self.rewards_last/float(num_prints) > threshold:
                    print(self.__class__,"Over threshold",threshold,"after",self.counter,"steps and",i,"episodes")
                    return
                self.rewards_last = 0
                self.cycles_last = 0
                self.counter_last=0
...
if __name__ == '__main__':
    ...
    fl_test.start_env(num_prints=100,threshold=0,random_seed=0)
    fl_test.start_env(num_prints=100, threshold=0, random_seed=1,should_print=False)