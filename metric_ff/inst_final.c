...
int_pointer lpos[MAX_PREDICATES] = {NULL};
int_pointer lneg[MAX_PREDICATES] = {NULL};
int_pointer luse[MAX_PREDICATES] = {NULL};
int_pointer lindex[MAX_PREDICATES] = {NULL};
 ...
 */
int_pointer lf_def[MAX_FUNCTIONS] = {NULL};
int_pointer lf_index[MAX_FUNCTIONS] = {NULL};
